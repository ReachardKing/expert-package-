...
local toggle_spotlight = 74 -- control id to toggle the various spotlight states Default: INPUT_PhoneCameraGrid (G) 183 
...
function IsPlayerInPolmav()
	...
	for i = 1,#heli do
		...
		if rightveh then return IsVehicleModel(vehicle, heli[i]) end
	end
end
