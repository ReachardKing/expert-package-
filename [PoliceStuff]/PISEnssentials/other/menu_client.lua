...
Citizen.CreateThread(function()
	...
	WarMenu.CreateSubMenu('conorner', 'PIS:conorner', 'Interactions')
	WarMenu.SetTitleBackgroundColor('PIS:conorner', 15, 125, 255)
	WarMenu.SetTitleColor('PIS:conorner', 255, 255, 255, 255)
    ...
    while true do
        if WarMenu.IsMenuOpened('PIS:main') then
			...
			elseif WarMenu.MenuButton('conorner', 'PIS:conorner') then
		...
		elseif WarMenu.IsMenuOpened('PIS:rdo') then
            ...
            elseif WarMenu.IsMenuOpened('PIS:rdo') then
				if WarMenu.Button('Call conorner') then
        ...
        elseif WarMenu.IsMenuOpened('PIS:misc') then
            ...
            WarMenu.Display()
        elseif IsDisabledControlPressed(1, modifier) and IsDisabledControlJustPressed(1, mainmnu) and IsPIS == true then
...
Citizen.CreateThread(function()
    ...
    while true do		
        ...
        elseif WarMenu.IsMenuOpened('trfc:tkt') then
            ...
            WarMenu.Display()
		elseif IsPIS and IsDisabledControlPressed(1, modifier) and IsDisabledControlJustPressed(1, trfmnu) and stopped == true and GetDistanceBetweenCoords(GetEntityCoords(player), GetEntityCoords(stoppedDriver)) < 3 then --E
