...
Citizen.CreateThread(function()
	while true do
        Citizen.Wait(0)
		if IsPIS and IsControlJustPressed(0, 323) or IsControlJustPressed(0, 51) then --Press X or E
			...
			target = GetEntityPlayerIsFreeAimingAt(PlayerId()) -- get the ped you're aiming at
