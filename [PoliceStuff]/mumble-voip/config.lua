...
mumbleConfig = {
	...
	radioClickMaxChannel = 1500, -- Set the max amount of radio channels that will have local radio clicks enabled
	...
	radioChannelNames = { -- Add named radio channels (Defaults to [channel number] MHz)
		[1] = "LEO 1", -- Makes 1 a private frequency
		[2] = "LEO 2", -- Makes 2 a private frequency
		[3] = "LEO 3", -- Makes 3 a private frequency
		[4] = "LEO 4", -- Makes 4 a private frequency
		[5] = "LEO 5", -- Makes 5 a private frequency
		[6] = "LEO 6", -- Makes 6 a private frequency
		[7] = "LEO 7", -- Makes 7 a private frequency
		[8] = "LEO 8", -- Makes 8 a private frequency
		[9] = "LEO 9", -- Makes 9 a private frequency
		[10] = "LEO 10", -- Makes 10 a private frequency
		[11] = "LEO 11", -- Makes 11 a private frequency
		[12] = "LEO 12", -- Makes 12 a private frequency
